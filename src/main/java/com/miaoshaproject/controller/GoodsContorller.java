...
//        return "goods_list";
    ...
    @ResponseBody
    public Result<GoodsDetailVo> toDetail2(MiaoshaUser user, @PathVariable("goodsId")long goodsId, Model model, HttpServletRequest request, HttpServletResponse response){
        //snowflake
...
//        return "goods_detail";
    ...
    @ResponseBody
    public String toDetail(MiaoshaUser user, @PathVariable("goodsId")long goodsId, Model model,HttpServletRequest request, HttpServletResponse response){
        //snowflake
        GoodsVo goodsVo = goodsService.getGoodsVoByGoodsId(goodsId);
        long startTime = goodsVo.getStartDate().getTime();
        long endTime = goodsVo.getEndDate().getTime();
